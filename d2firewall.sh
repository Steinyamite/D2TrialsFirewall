...
sudo iptables -I FORWARD -d 103.10.124.0/24 -j DROP
sudo iptables -I FORWARD -d 103.10.125.0/24 -j DROP
sudo iptables -I FORWARD -d 103.28.54.0/24 -j DROP
sudo iptables -I FORWARD -d 103.28.55.0/24 -j DROP
sudo iptables -I FORWARD -d 146.66.154.0/24 -j DROP
sudo iptables -I FORWARD -d 146.66.155.0/24 -j DROP
sudo iptables -I FORWARD -d 146.66.156.0/23 -j DROP
...
sudo iptables -I FORWARD -d 155.133.232.0/24 -j DROP
sudo iptables -I FORWARD -d 155.133.233.0/24 -j DROP
sudo iptables -I FORWARD -d 155.133.234.0/24 -j DROP
sudo iptables -I FORWARD -d 155.133.238.0/24 -j DROP
sudo iptables -I FORWARD -d 155.133.239.0/24 -j DROP
sudo iptables -I FORWARD -d 155.133.242.0/23 -j DROP
sudo iptables -I FORWARD -d 155.133.244.0/24 -j DROP
sudo iptables -I FORWARD -d 155.133.245.0/24 -j DROP
sudo iptables -I FORWARD -d 155.133.246.0/23 -j DROP
sudo iptables -I FORWARD -d 155.133.248.0/24 -j DROP
sudo iptables -I FORWARD -d 155.133.249.0/24 -j DROP
sudo iptables -I FORWARD -d 155.133.250.0/24 -j DROP
sudo iptables -I FORWARD -d 155.133.251.0/24 -j DROP
sudo iptables -I FORWARD -d 155.133.252.0/24 -j DROP
...
sudo iptables -I FORWARD -d 162.254.197.0/24 -j DROP
sudo iptables -I FORWARD -d 162.254.198.0/24 -j DROP
sudo iptables -I FORWARD -d 162.254.199.0/24 -j DROP
sudo iptables -I FORWARD -d 185.25.180.0/23 -j DROP
sudo iptables -I FORWARD -d 185.25.182.0/24 -j DROP
sudo iptables -I FORWARD -d 185.25.183.0/24 -j DROP
sudo iptables -I FORWARD -d 190.216.121.0/24 -j DROP
sudo iptables -I FORWARD -d 190.217.33.0/24 -j DROP
sudo iptables -I FORWARD -d 192.69.98.0/24 -j DROP
sudo iptables -I FORWARD -d 192.69.99.0/24 -j DROP
sudo iptables -I FORWARD -d 205.185.194.0/24 -j DROP
sudo iptables -I FORWARD -d 205.196.6.0/24 -j DROP
sudo iptables -I FORWARD -d 208.64.200.0/24 -j DROP
sudo iptables -I FORWARD -d 208.64.201.0/24 -j DROP
sudo iptables -I FORWARD -d 208.64.202.0/24 -j DROP
sudo iptables -I FORWARD -d 208.64.203.0/24 -j DROP
sudo iptables -I FORWARD -d 208.78.164.0/24 -j DROP
sudo iptables -I FORWARD -d 208.78.165.0/24 -j DROP
sudo iptables -I FORWARD -d 208.78.166.0/24 -j DROP
sudo iptables -I FORWARD -d 45.121.184.0/23 -j DROP
sudo iptables -I FORWARD -d 45.121.186.0/23 -j DROP
